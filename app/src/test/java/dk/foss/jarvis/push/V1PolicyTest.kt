...
class V1PolicyTest {
    ...
    fun `null error maps to ConfirmAndClear`() {
        assertEquals(RevokeAction.ConfirmAndClear, RevokeV1Policy.classify(null))
    }
    ...
    fun `device_not_found maps to ConfirmAndClear`() {
        ...
        assertEquals(RevokeAction.ConfirmAndClear, RevokeV1Policy.classify(err))
    }
    ...
    fun `device_auth_failed maps to KeepAndError`() {
        ...
        assertEquals(RevokeAction.KeepAndError, RevokeV1Policy.classify(err))
    }

    @Test
    fun `unknown rpcCode maps to KeepAndError`() {
    ...
    fun `NETWORK failure maps to Retry`() {
        ...
        assertEquals(RevokeAction.Retry, RevokeV1Policy.classify(err))
    }
